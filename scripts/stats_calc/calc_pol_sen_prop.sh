...
# Run script
~/.conda/envs/water_qual_env/bin/python scripts/stats_calc/calc_pol_sen_prop.py ${wd} ${site_codes[$SLURM_ARRAY_TASK_ID]} ${predictor} ${sen_class}
