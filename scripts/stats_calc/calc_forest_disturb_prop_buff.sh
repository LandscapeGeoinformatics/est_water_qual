...
#SBATCH -p main
#SBATCH -J calc_forest_disturb_prop_buff
#SBATCH -N 4
...
# Run script
~/.conda/envs/water_qual_env/bin/python scripts/stats_calc/calc_forest_disturb_prop_buff.py ${wd} ${site_codes[$SLURM_ARRAY_TASK_ID]} ${predictor} ${buff_dist}
