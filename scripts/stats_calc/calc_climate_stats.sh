...
# Input variables
working_dir=/gpfs/rocket/samba/gis
...
# Run script
~/.conda/envs/water_qual_env/bin/python scripts/stats_calc/calc_climate_stats.py ${working_dir} ${site_codes[$SLURM_ARRAY_TASK_ID]} ${predictor}
